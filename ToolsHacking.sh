...
do
clear
echo $tai "["$daun"!"$tai"]"$merah "© AiFaL_404"
sleep 2
sh logog.sh
...
clear
echo $tai
cowsay -f kiss.cow "AiFaL404"
echo 	
echo			
echo	$cyyan "      Code By "$merah"AiFaL404"
echo
echo
echo
echo $daun
...
then
clear
cowsay -f dragon.cow "AiFaL404" | lolcat
echo
echo
...
echo $merah "[]=============================[]"
echo $merah "[]"$daun" Author    : AiFaL_404 "$merah"[]"
echo $merah "[]"$daun" Nama      : AiFaL404       "$merah"[]"
echo $merah "[]"$daun" Panggilan : AiFal404   "$merah"[]"
echo $merah "[]"$daun" Umur      : 13 = SD      "$merah"[]"
echo $merah "[]"$daun" No Telp   : 089xxxxxxxxx "$merah"[]"
echo $merah "[]"$daun" Youtube   : Yt UNKOWN    "$merah"[]"
echo $merah "[]=============================[]"
echo
echo $merah "[]=============================[]"
...
echo $merah "[]"$daun" code       : AiFaL404         "$merah"[]"
echo $merah "[]=============================[] "
echo
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo $merah "[]"$daun"               MyGrup              "$merah"[]"
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo $merah "[] "$tai"1.SYSTEM_ERROR404           "$merah"    []"
echo $merah "[] "$tai"2.Muslim Army Cyber [ Admin ]   "$merah"    []"
echo $merah "[]XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX[]"
echo
echo
